...
export const UPDATE_MY_REVIEW_INDEX = 'UPDATE_MY_REVIEW_INDEX'
export const READ_REVIEWS_START = 'READ_REVIEWS_START'
export const READ_REVIEWS_END = 'READ_REVIEWS_END'
export const ADD_NEW_REVIEW = 'ADD_NEW_REVIEW'
export const REVIEW_AMOUNT_PLUS_ONE = 'REVIEW_AMOUNT_PLUS_ONE'
